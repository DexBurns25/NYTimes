...
let key = "DWIISvmUVS1ANeGZhZZsR1lWMw4m0OWI"
...
const appendTitle = (article) => {
  ...
  $(".article-list").append(`<div class='well'><h4><a href=${article.web_url}>${headline} ${pub_date}</a></h4><p class='caps'>${article.byline.original}</p></div>`);
}
